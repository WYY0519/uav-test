<template>
  ...
  <div class="control-group">
    <div class="button-group-container">
      <el-button type="info" :disabled="isDrawing || isViewing" class="control-btn" @click="handleDraw">
        <el-icon>
          <EditPen />
        </el-icon>
        绘制
      </el-button>
      <el-button type="info" :disabled="!isDrawing || drawnPoints.length < 2" class="control-btn"
      ...
      <el-button type="info" :disabled="!isDrawing" class="control-btn" @click="handleCancel">
        <el-icon>
          <Close />
        </el-icon>
        取消
    ...
    <el-button class="control-btn emergency" type="info" @click="handleSaveRoute" :disabled="!saveRouteBot"
      :loading="savingRoute">
      <el-icon>
        <Download />
      </el-icon>
