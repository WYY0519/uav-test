...
const noFlyZoneToolbar = ref(false); // let改为const，符合ref规范
...
// ==========定义updateZoneDataOnEdit（原updateZoneData重命名+提前定义） ==========
...
// ========== 重构completeEdit（移除routeInfo/emit/未定义接口，修复未定义报错） ==========
